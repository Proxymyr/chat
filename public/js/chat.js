...
function setUsername() {
    ...
    // TODO Verif server-side
    if (newUsername === 'Vega' || newUsername === 'Poxymyr') {
...
function setUserData(newUsername, newAvatar) {
    var request = new XMLHttpRequest();
    request.open('PUT', encodeURI('api/user/' + username), true);
    request.setRequestHeader('Content-Type', 'application/json');
    request.send(JSON.stringify({ 'username': newUsername, 'avatar': newAvatar }));
